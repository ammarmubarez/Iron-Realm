-- Migration 010: Patron lift (signature exercise)
-- Run AFTER 009_equipped_aspect.sql. Safe to re-run.
--
-- Lets users pin one exercise as their public "signature lift".
-- Capped at 100 chars; nullable. Shown in friend profile viewer.

ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS patron_lift text
    CHECK (patron_lift IS NULL OR length(patron_lift) <= 100);
