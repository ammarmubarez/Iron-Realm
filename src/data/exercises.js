...
export const EXERCISE_DB = {
  ...
  chest: [
    // ── BARBELL ──────────────────────────────────────────────────────────────
    { name: "Bench Press", angle: "Flat (0°)",                  diff: "intermediate", type: "strength",     primary: "chest",     svgTargets: ["mid-lower-pectoralis","upper-pectoralis","anterior-deltoid","lateral-head-triceps","medial-head-triceps","long-head-triceps"] },
    { name: "Incline Bench Press", angle: "30–45°",          diff: "intermediate", type: "strength",     primary: "chest",     svgTargets: ["upper-pectoralis","anterior-deltoid","mid-lower-pectoralis","lateral-head-triceps","medial-head-triceps","long-head-triceps"] },
    ...
    // ── DUMBBELL ─────────────────────────────────────────────────────────────
    { name: "Dumbbell Bench Press", angle: "Flat (0°)",         diff: "beginner",     type: "strength",     primary: "chest",     svgTargets: ["mid-lower-pectoralis","upper-pectoralis","anterior-deltoid","lateral-head-triceps","medial-head-triceps","long-head-triceps"] },
    { name: "Incline Dumbbell Press", angle: "30–45°",       diff: "intermediate", type: "strength",     primary: "chest",     svgTargets: ["upper-pectoralis","anterior-deltoid","mid-lower-pectoralis","lateral-head-triceps","medial-head-triceps","long-head-triceps"] },
    ...
    { name: "Incline Dumbbell Flyes", angle: "30–45°",       diff: "beginner",     type: "strength",     primary: "chest",     svgTargets: ["upper-pectoralis","mid-lower-pectoralis","anterior-deltoid"] },
    ...
    { name: "Dumbbell Pullover",            diff: "intermediate", type: "strength",     primary: "chest",     svgTargets: ["mid-lower-pectoralis","lats","long-head-triceps","upper-pectoralis"] },
    // ── MACHINE ──────────────────────────────────────────────────────────────
    ...
    { name: "Incline Chest Press Machine", angle: "30–45°",  diff: "beginner",     type: "strength",     primary: "chest",     svgTargets: ["upper-pectoralis","anterior-deltoid","mid-lower-pectoralis","lateral-head-triceps","medial-head-triceps","long-head-triceps"] },
    ...
    { name: "Low Cable Fly", angle: "Cable set at bottom",                diff: "beginner",     type: "strength",     primary: "chest",     svgTargets: ["upper-pectoralis","mid-lower-pectoralis","anterior-deltoid"] },
    ...
    { name: "Converging Chest Press Machine", diff: "beginner",  type: "strength",     primary: "chest",     svgTargets: ["mid-lower-pectoralis","upper-pectoralis","anterior-deltoid","lateral-head-triceps","medial-head-triceps","long-head-triceps"] },
    ...
    { name: "Landmine Press",               diff: "intermediate", type: "strength",     primary: "chest",     svgTargets: ["upper-pectoralis","anterior-deltoid","mid-lower-pectoralis","lateral-head-triceps","medial-head-triceps","long-head-triceps"] },
    // ── CALISTHENICS ─────────────────────────────────────────────────────────
    { name: "Push-ups",                     diff: "beginner",     type: "calisthenics", primary: "chest",     svgTargets: ["mid-lower-pectoralis","upper-pectoralis","lateral-head-triceps","anterior-deltoid","medial-head-triceps","long-head-triceps"] },
    { name: "Wide Push-ups",                diff: "beginner",     type: "calisthenics", primary: "chest",     svgTargets: ["mid-lower-pectoralis","upper-pectoralis","anterior-deltoid","lateral-head-triceps","medial-head-triceps","long-head-triceps"] },
    { name: "Diamond Push-ups",             diff: "intermediate", type: "calisthenics", primary: "chest",     svgTargets: ["lateral-head-triceps","medial-head-triceps","mid-lower-pectoralis","long-head-triceps","upper-pectoralis","anterior-deltoid"] },
    { name: "Decline Push-ups",             diff: "intermediate", type: "calisthenics", primary: "chest",     svgTargets: ["upper-pectoralis","mid-lower-pectoralis","anterior-deltoid","lateral-head-triceps","medial-head-triceps","long-head-triceps","upper-abdominals"] },
    { name: "Shoulder Tap Push-ups",        diff: "intermediate", type: "calisthenics", primary: "chest",     svgTargets: ["mid-lower-pectoralis","upper-pectoralis","anterior-deltoid","lateral-head-triceps","obliques","medial-head-triceps","upper-abdominals","lower-abdominals","long-head-triceps"] },
    { name: "Incline Push-ups",             diff: "beginner",     type: "calisthenics", primary: "chest",     svgTargets: ["mid-lower-pectoralis","upper-pectoralis","lateral-head-triceps","anterior-deltoid","medial-head-triceps","long-head-triceps"] },
    { name: "Dips",                         diff: "advanced",     type: "calisthenics", primary: "chest",     svgTargets: ["mid-lower-pectoralis","lateral-head-triceps","anterior-deltoid","medial-head-triceps","long-head-triceps","upper-pectoralis"] },
    { name: "Archer Push-ups",              diff: "advanced",     type: "calisthenics", primary: "chest",     svgTargets: ["mid-lower-pectoralis","lateral-head-triceps","upper-pectoralis","medial-head-triceps","anterior-deltoid","long-head-triceps","obliques","upper-abdominals"] },
    { name: "Clap Push-ups",                diff: "advanced",     type: "calisthenics", primary: "chest",     svgTargets: ["mid-lower-pectoralis","lateral-head-triceps","upper-pectoralis","anterior-deltoid","medial-head-triceps","long-head-triceps","upper-abdominals","lower-abdominals"] },
    { name: "Ring Push-ups",                diff: "advanced",     type: "calisthenics", primary: "chest",     svgTargets: ["mid-lower-pectoralis","upper-pectoralis","anterior-deltoid","lateral-head-triceps","medial-head-triceps","long-head-triceps","upper-abdominals","lower-abdominals","obliques"] },
    { name: "Svend Press",                  diff: "beginner",     type: "strength",     primary: "chest",     svgTargets: ["mid-lower-pectoralis","upper-pectoralis","anterior-deltoid"] },
    ...
    { name: "Single Arm Cable Fly",         diff: "intermediate", type: "strength",     primary: "chest",     svgTargets: ["mid-lower-pectoralis","upper-pectoralis","anterior-deltoid","obliques"] },
    { name: "Pseudo Planche Push-up",       diff: "elite",        type: "calisthenics", primary: "chest",     svgTargets: ["anterior-deltoid","mid-lower-pectoralis","upper-pectoralis","lateral-head-triceps","medial-head-triceps","long-head-triceps","upper-abdominals","lower-abdominals","obliques","wrist-flexors"] },
    { name: "Resistance Band Fly",          diff: "beginner",     type: "strength",     primary: "chest",     svgTargets: ["mid-lower-pectoralis","upper-pectoralis","anterior-deltoid"] },
  ],
  ...
  back: [
    ...
    { name: "Barbell Row",                  diff: "advanced",     type: "strength",     primary: "back",      svgTargets: ["lats","traps-middle","posterior-deltoid","lower-trapezius","lowerback","long-head-bicep","short-head-bicep","upper-trapezius","wrist-flexors"] },
    { name: "Pendlay Row",                  diff: "advanced",     type: "strength",     primary: "back",      svgTargets: ["lats","traps-middle","posterior-deltoid","lower-trapezius","long-head-bicep","lowerback","short-head-bicep","upper-trapezius","wrist-flexors"] },
    ...
    // ── DUMBBELL ─────────────────────────────────────────────────────────────
    { name: "Dumbbell Row",                 diff: "beginner",     type: "strength",     primary: "back",      svgTargets: ["lats","traps-middle","posterior-deltoid","lower-trapezius","long-head-bicep","short-head-bicep","wrist-flexors","obliques","lowerback"] },
    { name: "Dumbbell Pullover",            diff: "intermediate", type: "strength",     primary: "back",      svgTargets: ["mid-lower-pectoralis","lats","long-head-triceps","upper-pectoralis"] },
    { name: "Chest Supported Row", angle: "30–45° prone",          diff: "beginner",     type: "strength",     primary: "back",      svgTargets: ["traps-middle","lats","lower-trapezius","posterior-deltoid","long-head-bicep","short-head-bicep","wrist-flexors"] },
    { name: "Shrugs",                       diff: "beginner",     type: "strength",     primary: "back",      svgTargets: ["upper-trapezius","traps-middle","wrist-flexors"] },
    // ── MACHINE ──────────────────────────────────────────────────────────────
    { name: "Lat Pulldown",                 diff: "intermediate", type: "strength",     primary: "back",      svgTargets: ["lats","long-head-bicep","lower-trapezius","short-head-bicep","traps-middle","posterior-deltoid","wrist-flexors"] },
    { name: "Wide-Grip Lat Pulldown",       diff: "intermediate", type: "strength",     primary: "back",      svgTargets: ["lats","lower-trapezius","traps-middle","posterior-deltoid","long-head-bicep","short-head-bicep","wrist-flexors"] },
    { name: "Reverse-Grip Lat Pulldown",    diff: "intermediate", type: "strength",     primary: "back",      svgTargets: ["lats","short-head-bicep","long-head-bicep","lower-trapezius","traps-middle","posterior-deltoid","wrist-flexors"] },
    { name: "Seated Cable Row",             diff: "intermediate", type: "strength",     primary: "back",      svgTargets: ["lats","traps-middle","lower-trapezius","posterior-deltoid","long-head-bicep","short-head-bicep","wrist-flexors","lowerback"] },
    { name: "Wide-Grip Cable Row",          diff: "intermediate", type: "strength",     primary: "back",      svgTargets: ["traps-middle","posterior-deltoid","lower-trapezius","lats","long-head-bicep","short-head-bicep"] },
    { name: "T-Bar Row",                    diff: "advanced",     type: "strength",     primary: "back",      svgTargets: ["lats","traps-middle","lower-trapezius","posterior-deltoid","lowerback","long-head-bicep","short-head-bicep","wrist-flexors"] },
    { name: "Machine Row",                  diff: "beginner",     type: "strength",     primary: "back",      svgTargets: ["traps-middle","lats","lower-trapezius","posterior-deltoid","long-head-bicep","short-head-bicep"] },
    { name: "Cable Straight-Arm Pulldown",  diff: "intermediate", type: "strength",     primary: "back",      svgTargets: ["lats","long-head-triceps","mid-lower-pectoralis","posterior-deltoid","lower-trapezius"] },
    { name: "Face Pulls",                   diff: "beginner",     type: "strength",     primary: "back",      svgTargets: ["posterior-deltoid","traps-middle","lower-trapezius","upper-trapezius","lateral-deltoid"] },
    ...
    { name: "Chest Supported Row Machine",  diff: "beginner",     type: "strength",     primary: "back",      svgTargets: ["traps-middle","lats","lower-trapezius","posterior-deltoid","long-head-bicep","short-head-bicep","wrist-flexors"] },
    { name: "Iso-Lateral Row Machine",      diff: "intermediate", type: "strength",     primary: "back",      svgTargets: ["lats","traps-middle","lower-trapezius","posterior-deltoid","long-head-bicep","short-head-bicep"] },
    { name: "Lever Pullover Machine",       diff: "beginner",     type: "strength",     primary: "back",      svgTargets: ["lats","mid-lower-pectoralis","long-head-triceps","upper-pectoralis","posterior-deltoid","lower-trapezius"] },
    // ── CALISTHENICS ─────────────────────────────────────────────────────────
    { name: "Pull-ups",                     diff: "advanced",     type: "calisthenics", primary: "back",      svgTargets: ["lats","long-head-bicep","lower-trapezius","short-head-bicep","traps-middle","posterior-deltoid","wrist-flexors","mid-lower-pectoralis"] },
    { name: "Wide-Grip Pull-ups",           diff: "advanced",     type: "calisthenics", primary: "back",      svgTargets: ["lats","lower-trapezius","traps-middle","posterior-deltoid","long-head-bicep","short-head-bicep","wrist-flexors","mid-lower-pectoralis"] },
    { name: "Chin-ups",                     diff: "advanced",     type: "calisthenics", primary: "back",      svgTargets: ["lats","short-head-bicep","long-head-bicep","lower-trapezius","traps-middle","mid-lower-pectoralis","wrist-flexors","posterior-deltoid"] },
    { name: "Neutral-Grip Pull-ups",        diff: "advanced",     type: "calisthenics", primary: "back",      svgTargets: ["lats","long-head-bicep","short-head-bicep","lower-trapezius","traps-middle","wrist-flexors","posterior-deltoid","mid-lower-pectoralis"] },
    { name: "Inverted Row",                 diff: "intermediate", type: "calisthenics", primary: "back",      svgTargets: ["traps-middle","lats","posterior-deltoid","lower-trapezius","short-head-bicep","long-head-bicep","wrist-flexors"] },
    { name: "Scapular Pull-ups",            diff: "beginner",     type: "calisthenics", primary: "back",      svgTargets: ["lower-trapezius","lats","traps-middle","wrist-flexors"] },
    ...
    { name: "Meadows Row",                  diff: "advanced",     type: "strength",     primary: "back",      svgTargets: ["lats","traps-middle","posterior-deltoid","lower-trapezius","long-head-bicep","short-head-bicep","wrist-flexors","obliques"] },
    { name: "Kroc Row",                     diff: "advanced",     type: "strength",     primary: "back",      svgTargets: ["lats","traps-middle","posterior-deltoid","lower-trapezius","long-head-bicep","wrist-flexors","short-head-bicep","upper-trapezius","obliques"] },
    { name: "Seal Row", angle: "Flat bench, prone",                     diff: "intermediate", type: "strength",     primary: "back",      svgTargets: ["traps-middle","lats","lower-trapezius","posterior-deltoid","long-head-bicep","short-head-bicep","wrist-flexors"] },
    { name: "Cable Row (Single Arm)",       diff: "intermediate", type: "strength",     primary: "back",      svgTargets: ["lats","traps-middle","lower-trapezius","posterior-deltoid","long-head-bicep","short-head-bicep","obliques","wrist-flexors"] },
    { name: "Banded Pull-apart",            diff: "beginner",     type: "strength",     primary: "back",      svgTargets: ["posterior-deltoid","traps-middle","lower-trapezius","lateral-deltoid"] },
    { name: "Resistance Band Row",          diff: "beginner",     type: "strength",     primary: "back",      svgTargets: ["lats","traps-middle","lower-trapezius","posterior-deltoid","long-head-bicep","short-head-bicep"] },
    { name: "Straight Arm Cable Pulldown",  diff: "intermediate", type: "strength",     primary: "back",      svgTargets: ["lats","long-head-triceps","mid-lower-pectoralis","posterior-deltoid","lower-trapezius"] },
    { name: "Neutral Grip Lat Pulldown",    diff: "intermediate", type: "strength",     primary: "back",      svgTargets: ["lats","long-head-bicep","short-head-bicep","lower-trapezius","traps-middle","posterior-deltoid","wrist-flexors"] },
  ...
  shoulders: [
    // ── BARBELL ──────────────────────────────────────────────────────────────
    { name: "Overhead Press",               diff: "advanced",     type: "strength",     primary: "shoulders", svgTargets: ["anterior-deltoid","lateral-deltoid","upper-trapezius","medial-head-triceps","lateral-head-triceps","long-head-triceps","upper-pectoralis","lowerback"] },
    { name: "Push Press",                   diff: "advanced",     type: "strength",     primary: "shoulders", svgTargets: ["anterior-deltoid","upper-trapezius","lateral-deltoid","medial-head-triceps","outer-quadricep","lateral-head-triceps","long-head-triceps","rectus-femoris","inner-quadricep","gluteus-maximus","gastrocnemius","lowerback"] },
    { name: "Behind-the-Neck Press",        diff: "elite",        type: "strength",     primary: "shoulders", svgTargets: ["lateral-deltoid","anterior-deltoid","upper-trapezius","medial-head-triceps","lateral-head-triceps","posterior-deltoid","long-head-triceps"] },
    { name: "Upright Row",                  diff: "intermediate", type: "strength",     primary: "shoulders", svgTargets: ["lateral-deltoid","upper-trapezius","anterior-deltoid","posterior-deltoid","short-head-bicep","long-head-bicep","wrist-flexors"] },
    // ── DUMBBELL ─────────────────────────────────────────────────────────────
    { name: "Dumbbell Shoulder Press",      diff: "intermediate", type: "strength",     primary: "shoulders", svgTargets: ["anterior-deltoid","lateral-deltoid","medial-head-triceps","upper-trapezius","lateral-head-triceps","long-head-triceps","upper-pectoralis"] },
    { name: "Arnold Press", angle: "90° upright",                 diff: "intermediate", type: "strength",     primary: "shoulders", svgTargets: ["anterior-deltoid","lateral-deltoid","medial-head-triceps","upper-trapezius","lateral-head-triceps","posterior-deltoid","long-head-triceps","upper-pectoralis"] },
    { name: "Lateral Raises",               diff: "beginner",     type: "strength",     primary: "shoulders", svgTargets: ["lateral-deltoid","upper-trapezius","anterior-deltoid","posterior-deltoid"] },
    { name: "Front Raises",                 diff: "beginner",     type: "strength",     primary: "shoulders", svgTargets: ["anterior-deltoid","lateral-deltoid","upper-pectoralis","upper-trapezius"] },
    { name: "Bent-Over Rear Delt Raise",    diff: "beginner",     type: "strength",     primary: "shoulders", svgTargets: ["posterior-deltoid","traps-middle","lower-trapezius","lateral-deltoid"] },
    { name: "Scaption",                     diff: "beginner",     type: "strength",     primary: "shoulders", svgTargets: ["anterior-deltoid","lateral-deltoid","upper-trapezius"] },
    // ── MACHINE / CABLE ──────────────────────────────────────────────────────
    { name: "Machine Shoulder Press", angle: "90° upright",       diff: "beginner",     type: "strength",     primary: "shoulders", svgTargets: ["anterior-deltoid","lateral-deltoid","medial-head-triceps","lateral-head-triceps","upper-trapezius","long-head-triceps"] },
    { name: "Cable Lateral Raise",          diff: "beginner",     type: "strength",     primary: "shoulders", svgTargets: ["lateral-deltoid","upper-trapezius","anterior-deltoid","posterior-deltoid"] },
    { name: "Cable Front Raise",            diff: "beginner",     type: "strength",     primary: "shoulders", svgTargets: ["anterior-deltoid","lateral-deltoid","upper-pectoralis","upper-trapezius"] },
    { name: "Cable Rear Delt Fly",          diff: "beginner",     type: "strength",     primary: "shoulders", svgTargets: ["posterior-deltoid","traps-middle","lower-trapezius","lateral-deltoid"] },
    { name: "Pec Deck Reverse Fly",         diff: "beginner",     type: "strength",     primary: "shoulders", svgTargets: ["posterior-deltoid","traps-middle","lower-trapezius","lateral-deltoid"] },
    { name: "Machine Lateral Raise",        diff: "beginner",     type: "strength",     primary: "shoulders", svgTargets: ["lateral-deltoid","upper-trapezius","anterior-deltoid"] },
    { name: "Deltoid Fly",                  diff: "beginner",     type: "strength",     primary: "shoulders", svgTargets: ["lateral-deltoid","posterior-deltoid","upper-trapezius","anterior-deltoid"] },
    { name: "Machine Rear Delt Fly",        diff: "beginner",     type: "strength",     primary: "shoulders", svgTargets: ["posterior-deltoid","traps-middle","lower-trapezius","lateral-deltoid"] },
    ...
    { name: "Smith Machine OHP",            diff: "intermediate", type: "strength",     primary: "shoulders", svgTargets: ["anterior-deltoid","lateral-deltoid","medial-head-triceps","upper-trapezius","lateral-head-triceps","long-head-triceps","upper-pectoralis"] },
    { name: "Landmine Lateral Raise",       diff: "intermediate", type: "strength",     primary: "shoulders", svgTargets: ["lateral-deltoid","anterior-deltoid","upper-trapezius"] },
    { name: "Landmine Press (Single)",      diff: "intermediate", type: "strength",     primary: "shoulders", svgTargets: ["anterior-deltoid","upper-pectoralis","mid-lower-pectoralis","lateral-head-triceps","medial-head-triceps","long-head-triceps","obliques"] },
    // ── CALISTHENICS ─────────────────────────────────────────────────────────
    { name: "Pike Push-ups",                diff: "intermediate", type: "calisthenics", primary: "shoulders", svgTargets: ["anterior-deltoid","lateral-deltoid","medial-head-triceps","lateral-head-triceps","upper-trapezius","long-head-triceps","upper-pectoralis"] },
    { name: "Handstand Push-ups",           diff: "elite",        type: "calisthenics", primary: "shoulders", svgTargets: ["anterior-deltoid","lateral-deltoid","medial-head-triceps","upper-trapezius","lateral-head-triceps","long-head-triceps","upper-pectoralis","upper-abdominals","wrist-flexors","obliques"] },
    { name: "Wall Handstand Push-ups",      diff: "advanced",     type: "calisthenics", primary: "shoulders", svgTargets: ["anterior-deltoid","lateral-deltoid","medial-head-triceps","upper-trapezius","lateral-head-triceps","long-head-triceps","upper-pectoralis","upper-abdominals"] },
    // Additional shoulder exercises
    { name: "Military Press",               diff: "advanced",     type: "strength",     primary: "shoulders", svgTargets: ["anterior-deltoid","lateral-deltoid","medial-head-triceps","upper-trapezius","lateral-head-triceps","long-head-triceps","upper-pectoralis"] },
    { name: "Seated Dumbbell Press", angle: "90° upright",        diff: "intermediate", type: "strength",     primary: "shoulders", svgTargets: ["anterior-deltoid","lateral-deltoid","medial-head-triceps","upper-trapezius","lateral-head-triceps","long-head-triceps","upper-pectoralis"] },
    { name: "Z Press", angle: "Seated on floor, 90°",                      diff: "advanced",     type: "strength",     primary: "shoulders", svgTargets: ["anterior-deltoid","lateral-deltoid","medial-head-triceps","upper-trapezius","upper-abdominals","lateral-head-triceps","long-head-triceps","lowerback","lower-abdominals","obliques"] },
    { name: "Bradford Press",               diff: "advanced",     type: "strength",     primary: "shoulders", svgTargets: ["anterior-deltoid","lateral-deltoid","upper-trapezius","posterior-deltoid","medial-head-triceps","lateral-head-triceps","long-head-triceps"] },
    { name: "Barbell Upright Row",          diff: "intermediate", type: "strength",     primary: "shoulders", svgTargets: ["lateral-deltoid","upper-trapezius","anterior-deltoid","posterior-deltoid","short-head-bicep","long-head-bicep","wrist-flexors"] },
    { name: "Cable Upright Row",            diff: "intermediate", type: "strength",     primary: "shoulders", svgTargets: ["lateral-deltoid","upper-trapezius","anterior-deltoid","posterior-deltoid","short-head-bicep","long-head-bicep","wrist-flexors"] },
    { name: "Dumbbell Y Raise",             diff: "beginner",     type: "strength",     primary: "shoulders", svgTargets: ["lower-trapezius","posterior-deltoid","lateral-deltoid","anterior-deltoid","upper-trapezius"] },
    { name: "Dumbbell W Raise",             diff: "beginner",     type: "strength",     primary: "shoulders", svgTargets: ["posterior-deltoid","traps-middle","lower-trapezius","lateral-deltoid"] },
    { name: "Cable Y Raise",                diff: "beginner",     type: "strength",     primary: "shoulders", svgTargets: ["lower-trapezius","posterior-deltoid","lateral-deltoid","anterior-deltoid","upper-trapezius"] },
    { name: "Seated Cable Rear Delt Row",   diff: "beginner",     type: "strength",     primary: "shoulders", svgTargets: ["posterior-deltoid","traps-middle","lower-trapezius","long-head-bicep"] },
    { name: "Dumbbell 6-Ways",              diff: "intermediate", type: "strength",     primary: "shoulders", svgTargets: ["anterior-deltoid","lateral-deltoid","posterior-deltoid","upper-trapezius","lower-trapezius"] },
  ],
  ...
  legs: [
    ...
    { name: "Barbell Lunge",                diff: "advanced",     type: "strength",     primary: "legs",      svgTargets: ["outer-quadricep","gluteus-maximus","rectus-femoris","inner-quadricep","gluteus-medius","lateral-hamstrings","inner-thigh","lowerback","medial-hamstrings"] },
    { name: "Barbell Step-ups",             diff: "intermediate", type: "strength",     primary: "legs",      svgTargets: ["outer-quadricep","gluteus-maximus","inner-quadricep","rectus-femoris","gluteus-medius","lateral-hamstrings","medial-hamstrings","gastrocnemius","inner-thigh","lowerback","soleus"] },
    ...
    { name: "Walking Lunges",               diff: "intermediate", type: "strength",     primary: "legs",      svgTargets: ["outer-quadricep","gluteus-maximus","rectus-femoris","inner-quadricep","gluteus-medius","lateral-hamstrings","inner-thigh","medial-hamstrings","gastrocnemius","soleus","lowerback"] },
    { name: "Reverse Lunges",               diff: "intermediate", type: "strength",     primary: "legs",      svgTargets: ["gluteus-maximus","outer-quadricep","inner-quadricep","rectus-femoris","gluteus-medius","lateral-hamstrings","medial-hamstrings","inner-thigh"] },
    { name: "Bulgarian Split Squat",        diff: "advanced",     type: "strength",     primary: "legs",      svgTargets: ["gluteus-maximus","outer-quadricep","inner-quadricep","rectus-femoris","gluteus-medius","inner-thigh","lateral-hamstrings","medial-hamstrings","lowerback"] },
    ...
    { name: "Pistol Squat",                 diff: "elite",        type: "calisthenics", primary: "legs",      svgTargets: ["outer-quadricep","inner-quadricep","rectus-femoris","gluteus-maximus","gluteus-medius","soleus","inner-thigh","gastrocnemius","tibialis","lowerback","medial-hamstrings","upper-abdominals","obliques"] },
    ...
    { name: "Step-ups",                     diff: "beginner",     type: "calisthenics", primary: "legs",      svgTargets: ["outer-quadricep","gluteus-maximus","inner-quadricep","rectus-femoris","gluteus-medius","lateral-hamstrings","medial-hamstrings","gastrocnemius","inner-thigh","soleus"] },
    ...
    { name: "Sissy Squat",                  diff: "advanced",     type: "calisthenics", primary: "legs",      svgTargets: ["rectus-femoris","outer-quadricep","inner-quadricep","tibialis"] },
  ...
  glutes: [
    ...
    { name: "Bulgarian Split Squat",        diff: "advanced",     type: "strength",     primary: "glutes",    svgTargets: ["gluteus-maximus","outer-quadricep","inner-quadricep","rectus-femoris","gluteus-medius","inner-thigh","lateral-hamstrings","medial-hamstrings","lowerback"] },
  ...
  bicep: [
    ...
    { name: "Wide-Grip Barbell Curl",       diff: "beginner",     type: "strength",     primary: "bicep",     svgTargets: ["short-head-bicep","long-head-bicep","wrist-flexors"] },
    { name: "Reverse Barbell Curl",         diff: "intermediate", type: "strength",     primary: "bicep",     svgTargets: ["wrist-extensors","long-head-bicep","short-head-bicep"] },
    { name: "21s",                          diff: "intermediate", type: "strength",     primary: "bicep",     svgTargets: ["short-head-bicep","long-head-bicep","wrist-flexors"] },
    // ── DUMBBELL ─────────────────────────────────────────────────────────────
    ...
    { name: "Hammer Curl",                  diff: "beginner",     type: "strength",     primary: "bicep",     svgTargets: ["long-head-bicep","short-head-bicep","wrist-extensors","wrist-flexors"] },
    { name: "Concentration Curl", angle: "Seated, 90°",           diff: "beginner",     type: "strength",     primary: "bicep",     svgTargets: ["short-head-bicep","long-head-bicep","wrist-flexors"] },
    { name: "Incline Dumbbell Curl", angle: "45–60°",        diff: "intermediate", type: "strength",     primary: "bicep",     svgTargets: ["long-head-bicep","short-head-bicep","wrist-flexors"] },
    { name: "Spider Curl", angle: "45° prone on incline",                  diff: "intermediate", type: "strength",     primary: "bicep",     svgTargets: ["short-head-bicep","long-head-bicep","wrist-flexors"] },
    ...
    // ── MACHINE / CABLE ──────────────────────────────────────────────────────
    { name: "Preacher Curl",                diff: "intermediate", type: "strength",     primary: "bicep",     svgTargets: ["short-head-bicep","long-head-bicep","wrist-flexors"] },
    { name: "Machine Preacher Curl",        diff: "beginner",     type: "strength",     primary: "bicep",     svgTargets: ["short-head-bicep","long-head-bicep"] },
    { name: "Cable Curl",                   diff: "beginner",     type: "strength",     primary: "bicep",     svgTargets: ["short-head-bicep","long-head-bicep","wrist-flexors"] },
    { name: "High Cable Curl",              diff: "beginner",     type: "strength",     primary: "bicep",     svgTargets: ["short-head-bicep","long-head-bicep"] },
    { name: "Cable Hammer Curl",            diff: "beginner",     type: "strength",     primary: "bicep",     svgTargets: ["long-head-bicep","short-head-bicep","wrist-extensors","wrist-flexors"] },
    { name: "Bicep Curl Machine",           diff: "beginner",     type: "strength",     primary: "bicep",     svgTargets: ["short-head-bicep","long-head-bicep"] },
    { name: "Low Cable Curl",               diff: "beginner",     type: "strength",     primary: "bicep",     svgTargets: ["short-head-bicep","long-head-bicep","wrist-flexors"] },
    // ── CALISTHENICS ─────────────────────────────────────────────────────────
    { name: "Chin-ups",                     diff: "advanced",     type: "calisthenics", primary: "bicep",     svgTargets: ["lats","short-head-bicep","long-head-bicep","lower-trapezius","traps-middle","mid-lower-pectoralis","wrist-flexors","posterior-deltoid"] },
    { name: "Inverted Row (Supinated)",     diff: "intermediate", type: "calisthenics", primary: "bicep",     svgTargets: ["short-head-bicep","long-head-bicep","traps-middle","lats","posterior-deltoid","lower-trapezius","wrist-flexors"] },
    { name: "Bayesian Curl", angle: "Cable behind body",                diff: "intermediate", type: "strength",     primary: "bicep",     svgTargets: ["long-head-bicep","short-head-bicep","wrist-flexors"] },
    { name: "Cross Body Hammer Curl",       diff: "beginner",     type: "strength",     primary: "bicep",     svgTargets: ["long-head-bicep","wrist-extensors","short-head-bicep","wrist-flexors"] },
    { name: "Waiter Curl",                  diff: "beginner",     type: "strength",     primary: "bicep",     svgTargets: ["short-head-bicep","long-head-bicep","wrist-flexors"] },
    { name: "Drag Curl",                    diff: "intermediate", type: "strength",     primary: "bicep",     svgTargets: ["long-head-bicep","short-head-bicep","wrist-flexors"] },
    { name: "Resistance Band Curl",         diff: "beginner",     type: "strength",     primary: "bicep",     svgTargets: ["short-head-bicep","long-head-bicep","wrist-flexors"] },
    { name: "TRX Curl",                     diff: "intermediate", type: "calisthenics", primary: "bicep",     svgTargets: ["short-head-bicep","long-head-bicep","lats","wrist-flexors"] },
  ],
  ...
  tricep: [
    ...
    { name: "Assisted Dip Machine",         diff: "beginner",     type: "strength",     primary: "tricep",    svgTargets: ["lateral-head-triceps","medial-head-triceps","mid-lower-pectoralis","long-head-triceps","anterior-deltoid","upper-pectoralis"] },
    ...
    // ── CALISTHENICS ─────────────────────────────────────────────────────────
    { name: "Tricep Dips",                  diff: "intermediate", type: "calisthenics", primary: "tricep",    svgTargets: ["lateral-head-triceps","medial-head-triceps","long-head-triceps","anterior-deltoid","mid-lower-pectoralis","upper-pectoralis"] },
    ...
    { name: "Diamond Push-ups",             diff: "intermediate", type: "calisthenics", primary: "tricep",    svgTargets: ["lateral-head-triceps","medial-head-triceps","mid-lower-pectoralis","long-head-triceps","upper-pectoralis","anterior-deltoid"] },
    { name: "Pike Push-up Hold",            diff: "intermediate", type: "calisthenics", iso: true, primary: "tricep",    svgTargets: ["anterior-deltoid","medial-head-triceps","lateral-head-triceps","lateral-deltoid","long-head-triceps","upper-trapezius","upper-pectoralis"] },
    ...
    { name: "Ring Dips",                    diff: "elite",        type: "calisthenics", primary: "tricep",    svgTargets: ["mid-lower-pectoralis","lateral-head-triceps","anterior-deltoid","medial-head-triceps","long-head-triceps","upper-pectoralis"] },
  ],
  ...
  forearms: [
    ...
    { name: "Farmer's Walk",                diff: "intermediate", type: "strength",     primary: "forearms",  svgTargets: ["wrist-flexors","upper-trapezius","obliques","lowerback","gluteus-medius","traps-middle","upper-abdominals","outer-quadricep","gastrocnemius","soleus","lower-abdominals","inner-quadricep","rectus-femoris"] },
    { name: "Plate Pinch",                  diff: "beginner",     type: "strength",     primary: "forearms",  svgTargets: ["wrist-flexors","wrist-extensors"] },
    { name: "Dead Hang",                    diff: "beginner",     type: "calisthenics", iso: true, primary: "forearms",  svgTargets: ["wrist-flexors","lats","lower-trapezius"] },
    { name: "Towel Pull-ups",               diff: "advanced",     type: "calisthenics", primary: "forearms",  svgTargets: ["wrist-flexors","lats","long-head-bicep","short-head-bicep","lower-trapezius","traps-middle","posterior-deltoid","wrist-extensors"] },
    { name: "Hammer Curl",                  diff: "beginner",     type: "strength",     primary: "forearms",  svgTargets: ["long-head-bicep","short-head-bicep","wrist-extensors","wrist-flexors"] },
    { name: "Reverse Curl",                 diff: "beginner",     type: "strength",     primary: "forearms",  svgTargets: ["wrist-extensors","long-head-bicep","short-head-bicep"] },
  ...
  core: [
    ...
    { name: "Decline Sit-up", angle: "15–30°",               diff: "intermediate", type: "calisthenics", primary: "core",      svgTargets: ["upper-abdominals","lower-abdominals","rectus-femoris","obliques"] },
    { name: "Weighted Sit-up",              diff: "intermediate", type: "strength",     primary: "core",      svgTargets: ["upper-abdominals","lower-abdominals","rectus-femoris","obliques"] },
    { name: "Hanging Knee Raise",           diff: "intermediate", type: "calisthenics", primary: "core",      svgTargets: ["lower-abdominals","upper-abdominals","rectus-femoris","obliques","wrist-flexors"] },
    { name: "Hanging Leg Raises",           diff: "advanced",     type: "calisthenics", primary: "core",      svgTargets: ["lower-abdominals","upper-abdominals","rectus-femoris","obliques","wrist-flexors","lats"] },
    { name: "Lying Leg Raise",              diff: "beginner",     type: "calisthenics", primary: "core",      svgTargets: ["lower-abdominals","rectus-femoris","upper-abdominals","obliques"] },
    { name: "Reverse Crunch",               diff: "beginner",     type: "calisthenics", primary: "core",      svgTargets: ["lower-abdominals","upper-abdominals","obliques","rectus-femoris"] },
    { name: "Ab Wheel Rollout",             diff: "advanced",     type: "calisthenics", primary: "core",      svgTargets: ["upper-abdominals","lower-abdominals","obliques","lats","long-head-triceps"] },
    { name: "V-ups",                        diff: "intermediate", type: "calisthenics", primary: "core",      svgTargets: ["upper-abdominals","lower-abdominals","rectus-femoris","obliques"] },
    { name: "Toes to Bar",                  diff: "advanced",     type: "calisthenics", primary: "core",      svgTargets: ["lower-abdominals","upper-abdominals","rectus-femoris","lats","obliques","wrist-flexors"] },
    { name: "Dragon Flag",                  diff: "elite",        type: "calisthenics", primary: "core",      svgTargets: ["upper-abdominals","lower-abdominals","obliques","lats","rectus-femoris"] },
    { name: "L-Sit",                        diff: "elite",        type: "calisthenics", iso: true, primary: "core",      svgTargets: ["lower-abdominals","upper-abdominals","rectus-femoris","obliques","long-head-triceps","lats","lower-trapezius","anterior-deltoid"] },
    // ── OBLIQUES ─────────────────────────────────────────────────────────────
    ...
    { name: "Bicycle Crunch",               diff: "beginner",     type: "calisthenics", primary: "core",      svgTargets: ["obliques","upper-abdominals","lower-abdominals","rectus-femoris"] },
    // ── PLANK VARIATIONS ─────────────────────────────────────────────────────
    { name: "Plank",                        diff: "beginner",     type: "calisthenics", iso: true, primary: "core",      svgTargets: ["upper-abdominals","lower-abdominals","obliques","anterior-deltoid"] },
    { name: "Long-Lever Plank",             diff: "intermediate", type: "calisthenics", iso: true, primary: "core",      svgTargets: ["upper-abdominals","lower-abdominals","obliques","anterior-deltoid"] },
    { name: "Weighted Plank",               diff: "intermediate", type: "strength", iso: true,     primary: "core",      svgTargets: ["upper-abdominals","lower-abdominals","obliques","anterior-deltoid"] },
    { name: "Plank Reach",                  diff: "intermediate", type: "calisthenics", primary: "core",      svgTargets: ["upper-abdominals","lower-abdominals","obliques","anterior-deltoid"] },
    { name: "Dead Bug",                     diff: "beginner",     type: "calisthenics", primary: "core",      svgTargets: ["lower-abdominals","upper-abdominals","obliques","rectus-femoris"] },
    ...
    { name: "Ab Wheel (Kneeling)",          diff: "intermediate", type: "calisthenics", primary: "core",      svgTargets: ["upper-abdominals","lower-abdominals","obliques","lats","long-head-triceps"] },
    ...
    { name: "Copenhagen Plank",             diff: "advanced",     type: "calisthenics", iso: true, primary: "core",      svgTargets: ["inner-thigh","obliques","upper-abdominals","gluteus-medius","lower-abdominals"] },
    { name: "Stir the Pot",                 diff: "advanced",     type: "calisthenics", primary: "core",      svgTargets: ["upper-abdominals","lower-abdominals","obliques","anterior-deltoid"] },
    ...
    { name: "Weighted Decline Crunch", angle: "15–30°",      diff: "intermediate", type: "strength",     primary: "core",      svgTargets: ["upper-abdominals","lower-abdominals","obliques","rectus-femoris"] },
    { name: "Shoulder Tap Push-ups",        diff: "intermediate", type: "calisthenics", primary: "core",      svgTargets: ["mid-lower-pectoralis","upper-pectoralis","anterior-deltoid","lateral-head-triceps","obliques","medial-head-triceps","upper-abdominals","lower-abdominals","long-head-triceps"] },
    { name: "Hollow Body Hold",             diff: "intermediate", type: "calisthenics", iso: true, primary: "core",      svgTargets: ["lower-abdominals","upper-abdominals","rectus-femoris","obliques"] },
    { name: "Hollow Body Rock",             diff: "advanced",     type: "calisthenics", primary: "core",      svgTargets: ["lower-abdominals","upper-abdominals","obliques","rectus-femoris"] },
    { name: "GHD Sit-up", angle: "GHD at 0° (parallel)",                   diff: "advanced",     type: "calisthenics", primary: "core",      svgTargets: ["rectus-femoris","lower-abdominals","upper-abdominals","obliques","inner-thigh"] },
    { name: "Suitcase Carry",               diff: "intermediate", type: "strength",     primary: "core",      svgTargets: ["obliques","wrist-flexors","gluteus-medius","lowerback","upper-trapezius","upper-abdominals","lower-abdominals"] },
  ],
  ...
  calisthenics: [
    { name: "Muscle-up",                    diff: "elite",        type: "calisthenics", primary: "back",      svgTargets: ["lats","lateral-head-triceps","long-head-bicep","short-head-bicep","mid-lower-pectoralis","medial-head-triceps","lower-trapezius","anterior-deltoid","traps-middle","long-head-triceps","wrist-flexors","upper-pectoralis","lower-abdominals","upper-abdominals"] },
    { name: "Handstand",                    diff: "elite",        type: "calisthenics", primary: "shoulders", svgTargets: ["anterior-deltoid","lateral-deltoid","upper-trapezius","medial-head-triceps","upper-abdominals","wrist-flexors","obliques","lateral-head-triceps","lower-abdominals","long-head-triceps","lowerback"] },
    { name: "Front Lever",                  diff: "elite",        type: "calisthenics", iso: true, primary: "back",      svgTargets: ["lats","lower-abdominals","upper-abdominals","lower-trapezius","posterior-deltoid","obliques","wrist-flexors","long-head-triceps","long-head-bicep","mid-lower-pectoralis"] },
    { name: "Back Lever",                   diff: "elite",        type: "calisthenics", iso: true, primary: "back",      svgTargets: ["mid-lower-pectoralis","anterior-deltoid","upper-pectoralis","lats","lowerback","long-head-triceps","gluteus-maximus","upper-abdominals","wrist-flexors","lower-trapezius","lower-abdominals"] },
    { name: "Planche",                      diff: "elite",        type: "calisthenics", primary: "chest",     svgTargets: ["anterior-deltoid","mid-lower-pectoralis","upper-pectoralis","medial-head-triceps","lateral-head-triceps","upper-abdominals","wrist-flexors","long-head-triceps","lower-abdominals","lower-trapezius","obliques","lowerback","gluteus-maximus"] },
    { name: "Human Flag",                   diff: "elite",        type: "calisthenics", primary: "back",      svgTargets: ["obliques","lats","upper-abdominals","lower-abdominals","lateral-deltoid","wrist-flexors","anterior-deltoid","gluteus-medius","lateral-head-triceps","posterior-deltoid","short-head-bicep","medial-head-triceps","long-head-triceps","lowerback","gluteus-maximus"] },
    { name: "Burpees",                      diff: "intermediate", type: "calisthenics", primary: "core",      svgTargets: ["outer-quadricep","rectus-femoris","inner-quadricep","gluteus-maximus","gastrocnemius","mid-lower-pectoralis","anterior-deltoid","lateral-head-triceps","soleus","lateral-hamstrings","medial-head-triceps","upper-abdominals","medial-hamstrings","upper-pectoralis","lower-abdominals","long-head-triceps","obliques","lowerback"] },
  ],
};
