...
function FreeWorkoutScreen({ st, onLogExercise, onUnlogExercise, settings, toast }) {
  ...
  return (
    <div style={{ height: "100vh", overflowY: "auto", background: BG, padding: "0 0 80px", paddingTop: "env(safe-area-inset-top, 24px)" }}>
      {/* Header */}
...
function DatabaseScreen({ st, onLogExercise, onSaveCustomExercise, settings, toast }) {
  ...
  return (
    <div style={{ height: "100vh", overflowY: "auto", background: BG, padding: "20px 20px 80px", paddingTop: "calc(env(safe-area-inset-top, 24px) + 20px)" }}>
...
function MenuScreen({ st, setScreen, onLogFood, onUpdateWeight, settings, onUpdateSettings, toast }) {
  ...
  return (
    <div style={{ height: "100vh", overflowY: "auto", background: BG, padding: "0 0 80px", position: "relative", paddingTop: "env(safe-area-inset-top, 24px)" }}>
      {/* Background effects */}
